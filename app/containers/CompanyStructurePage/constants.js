/*
 *
 * CompanyStructurePage constants
 *
 */
...
export const GET_PARTY_GROUP_SUCCESS =
  'app/CompanyStructurePage/GET_PARTY_GROUP_SUCCESS';
export const GET_PARTY_GROUP_ERROR =
  'app/CompanyStructurePage/GET_PARTY_GROUP_ERROR';

export const CREATE_NEW_PARTY_GROUP =
  'app/CompanyStructurePage/CREATE_NEW_PARTY_GROUP';
export const CREATE_NEW_PARTY_GROUP_SUCCESS =
  'app/CompanyStructurePage/CREATE_NEW_PARTY_GROUP_SUCCESS';
...
export const GET_ALL_USERS = 'app/CompanyStructurePage/GET_ALL_USERS';
export const GET_ALL_USERS_SUCCESS =
  'app/CompanyStructurePage/GET_ALL_USERS_SUCCESS';
export const GET_ALL_USERS_ERROR =
  'app/CompanyStructurePage/GET_ALL_USERS_ERROR';

export const CREATE_NEW_PARTY = 'app/CompanyStructurePage/CREATE_NEW_PARTY';
export const CREATE_NEW_PARTY_SUCCESS =
